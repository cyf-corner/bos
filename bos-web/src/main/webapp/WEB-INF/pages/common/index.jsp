...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEp").click(function(){
			...
			if(v){
				...
				if(v1 == v2){
					//两次输入一致，发送ajax请求
					$.post("userAction_updatePwd.action",{"password":v1},function(data){
						if(data == '1'){
							//修改成功，关闭修改密码窗口
							$("#editPwdWindow").window("close");
						}else{
	...
	// 版权信息
	function showAbout(){
		$.messager.alert("宅急送 v1.0","管理员邮箱: cyf@java.com");
	}
</script>
</head>
<body class="easyui-layout">
	<div data-options="region:'north',border:false" style="height:80px;padding:10px;background:url('./images/header_bg.png') no-repeat right;">
		<div id="sessionInfoDiv" style="position: absolute;right: 5px;top:10px;">
			[<strong>${session.loginUser.username }</strong>]，欢迎你！
		</div>
				...
				<tr>
					<td style="width: 300px;">
						<div style="color: #999; font-size: 8pt;">
							我说到哪儿 | Powered by <a href="http://www.flyroc.top/">flyroc.top</a>
						</div>
					</td>
