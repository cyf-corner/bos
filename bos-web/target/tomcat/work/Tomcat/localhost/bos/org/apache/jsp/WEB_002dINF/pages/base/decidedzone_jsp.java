 ...
 * Generated at: 2018-11-03 05:38:01 UTC
...
public final class decidedzone_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t// 发送ajax请求，获取未关联定区的客户\r\n");
      out.write("\t\t\t$.post(\"decidedzoneAction_findListNotAssociation.action\",function(data){\r\n");
      ...
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t// 发送ajax请求，获取已关联定区的客户---->哪个定区？需要传参所选中行的定区id\r\n");
      out.write("\t\t\tvar decidedzoneId = rows[0].id;\r\n");
      out.write("\t\t\t$.post(\"decidedzoneAction_findListHasAssociation.action\",{\"id\":decidedzoneId},function(data){\r\n");
      out.write("\t\t\t\tif(data[0]!=null) {\r\n");
      out.write("\t\t\t\t\tfor(var i=0;i<data.length;i++) {\r\n");
      out.write("\t\t\t\t\t\t var id = data[i].id;\r\n");
      out.write("\t\t\t\t\t\t var name = data[i].name;\r\n");
      ...
      out.write("\t\t// ★★★★★遗留问题，当双击从service获取关联客户数据为null时，浏览器报错，阻止判断，无法正常控制页面元素。\r\n");
      out.write("\t\t$('#association_subarea').datagrid( {\r\n");
      out.write("\t\t\tfit : true,\r\n");
      out.write("\t\t\tborder : true,\r\n");
      out.write("\t\t\trownumbers : true,\r\n");
      out.write("\t\t\tstriped : true,\r\n");
      out.write("\t\t\turl : \"decidedzoneAction_findHasAssociationSubarea.action?id=\"+data.id,\r\n");
      out.write("\t\t\tcolumns : [ [{\r\n");
      out.write("\t\t\t\tfield : 'id',\r\n");
      ...
      out.write("\t\t\trownumbers : true,\r\n");
      out.write("\t\t\tstriped : true,\r\n");
      out.write("\t\t\turl : \"decidedzoneAction_findListHasAssociation?id=\"+data.id,\r\n");
      out.write("\t\t\tcolumns : [[{\r\n");
      out.write("\t\t\t\tfield : 'id',\r\n");
      ...
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"easyui-combobox\" name=\"staff.id\" data-options=\"valueField:'id',textField:'name', url:'staffAction_listajax.action'\" />  \r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr height=\"300\">\r\n");
      out.write("\t\t\t\t\t\t<td valign=\"top\">关联分区</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<table id=\"subareaGrid\" class=\"easyui-datagrid\" border=\"true\" style=\"width:480px;height:161px\" data-options=\"url:'subareaAction_listAjax.action',fitColumns:true,singleSelect:false,striped:true,rownumbers:true\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t        <tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t            <th data-options=\"field:'position',width:300\">位置</th>  \r\n");
      out.write("\t\t\t\t\t\t\t        </tr>\r\n");
      out.write("\t\t\t\t\t\t\t    </thead>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t<div style=\"overflow:auto;padding:5px;\">\r\n");
      ...
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- 隐藏域，将选中定区的id提交，然后后台处理与相应顾客关联 -->\r\n");
      ...
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"button\" value=\">>>>\" id=\"toRight\"><br/><br/>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"button\" value=\"&lt;&lt;&lt;&lt;\" id=\"toLeft\">\r\n");
      out.write("\t\t\t\t\t\t\t<script type=\"text/javascript\">\r\n");
      out.write("\t\t\t\t\t\t\t\t$(function(){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t// 左右移动按钮添加事件\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t// 点击绑定按钮最终提交\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$(\"#associationBtn\").click(function(){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar rows = $(\"#grid\").datagrid(\"getSelections\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar id = rows[0].id;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t// 为id为customerDecidedZoneId的隐藏域赋值\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$(\"#customerDecidedZoneId\").val(id);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t// 将下拉框中所有的选项选中，才能通过表单提交\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$(\"#associationSelect option\").attr(\"selected\",\"selected\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar flag = $(\"#associationSelect option\").length;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tif(flag == 0){// 此操作为防止select提交表单时，option的值为空，即右边下拉框全部清空导致的错误\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t$(\"#associationSelect\").append(\"<option value='-1' selected='selected'></option>\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t};\r\n");
