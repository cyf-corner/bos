 ...
 * Generated at: 2018-11-03 05:38:03 UTC
...
public final class staff_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tvar selRows = $(\"#grid\").datagrid(\"getSelections\");\r\n");
      out.write("\t\tif(selRows.length == 0){// 未选择需删除的行\r\n");
      out.write("\t\t\t$.messager.alert(\"提示信息\",\"请选择需要删除的取派员！\",\"warning\",\"确定\");\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\t$.messager.confirm(\"删除确认\",\"是否确定要删除所选中的取派员？\",function(r){\r\n");
      out.write("\t\t\t\tif(r){// 确定\r\n");
      out.write("\t\t\t\t\tvar arr = new Array();// 将要删除行的id放入数组，然后用逗号隔开变为字符串\r\n");
      out.write("\t\t\t\t\tfor(var i=0;i<selRows.length;i++){\r\n");
      out.write("\t\t\t\t\t\tvar staff = selRows[i];\r\n");
      out.write("\t\t\t\t\t\tvar id = staff.id;\r\n");
      out.write("\t\t\t\t\t\tarr.push(id);\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\tvar ids = arr.join(\",\");\r\n");
      out.write("\t\t\t\t\t// 由于此处删除之后需要将页面刷新，因此\r\n");
      ...
      out.write("\t\thandler : doView// 为按钮绑定点击事件\r\n");
      out.write("\t}, {\r\n");
      ...
      out.write("\t},\r\n");
      out.write("\t//Shiro框架提供的权限控制方式三(标签技术实现)：Shiro标签控制权限\r\n");
      out.write("\t");
      ...
      out.write("\t\r\n");
      out.write("\t$(function(){\r\n");
      out.write("\t\t// 先将body隐藏，再显示，不会出现页面刷新效果====>防止页面加载出现dialog等其他非主页信息\r\n");
      out.write("\t\t$(\"body\").css({visibility:\"visible\"});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t// 动态创建取派员信息表格\r\n");
      out.write("\t\t$('#grid').datagrid( {\r\n");
      out.write("\t\t\ticonCls : 'icon-forward',\r\n");
      out.write("\t\t\tfit : true,\r\n");
      out.write("\t\t\tborder : false,\r\n");
      out.write("\t\t\trownumbers : true,// 行号\r\n");
      out.write("\t\t\tstriped : true,// 纹理效果\r\n");
      out.write("\t\t\tpageList: [5,50,100],\r\n");
      out.write("\t\t\tpagination : true, // 是否显示分页条(分页)\r\n");
      out.write("\t\t\ttoolbar : toolbar,// 工具栏\r\n");
      out.write("\t\t\turl : \"staffAction_pageQuery.action\",\r\n");
      out.write("\t\t\tidField : 'id',// 指明哪一个字段是标识字段。操作的时候便拿该字段去后台\r\n");
      out.write("\t\t\tcolumns : columns,// 标题行的列名\r\n");
      out.write("\t\t\tonDblClickRow : doDblClickRow,// 双击事件\r\n");
      ...
      out.write("\t\t$('#editStaffWindow').form(\"load\",rowData);\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t//手机号校验\r\n");
      out.write("\t$(function(){\r\n");
      ...
      out.write("\t\t\tvar v = $('#addStaffForm').form(\"validate\");//若校验通过\r\n");
      out.write("\t\t\tif(v) {\r\n");
      out.write("\t\t\t\t$(\"#addStaffForm\").submit();//提交表单\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$('#update').click(function(){\r\n");
      out.write("\t\t\tvar v = $('#editStaffForm').form(\"validate\");//若校验通过\r\n");
      out.write("\t\t\tif(v) {\r\n");
      out.write("\t\t\t\t$(\"#editStaffForm\").submit();//提交表单\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t});\r\n");
      out.write("</script>\t\r\n");
      ...
      out.write("\r\n");
      out.write("\t<!-- 添加取派员 -->\r\n");
      out.write("\t<div class=\"easyui-window\" title=\"对收派员进行添加\" id=\"addStaffWindow\" collapsible=\"false\" minimizable=\"false\" maximizable=\"false\" style=\"top:20px;left:200px\">\r\n");
      ...
      out.write("\t\t<div region=\"north\" style=\"height:31px;overflow:hidden;\" split=\"false\" border=\"false\" >\r\n");
      out.write("\t\t\t<div class=\"datagrid-toolbar\">\r\n");
      out.write("\t\t\t\t<a id=\"update\" icon=\"icon-save\" href=\"#\" class=\"easyui-linkbutton\" plain=\"true\" >更新</a>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<div region=\"center\" style=\"overflow:auto;padding:5px;\" border=\"false\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"id\" readonly=\"readonly\" class=\"easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>姓名</td>\r\n");
      out.write("\t\t\t\t\t\t<td><input type=\"text\" name=\"name\" class=\"easyui-validatebox\" required=\"true\"/></td>\r\n");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/pages/base/staff.jsp(66,1) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
