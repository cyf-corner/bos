					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							<TR>
								...
								<td>拜访时间 ：</td>
								<td  >
									<INPUT class=textbox id="visit_time" type="text" style="WIDTH: 180px" maxLength=50 name="visit_time" readonly="readonly" value="<s:property value="#saleVisit.visit_time_s" />" >
								</td>
							</TR>
							...
							<TR>
								...
								<td>被拜访人 ：</td>
								<td >
								<INPUT class=textbox id=sChannel2 type="text" style="WIDTH: 180px" maxLength=50 name="visit_interviewee" value="<s:property value="#saleVisit.visit_interviewee" />" >
								</td>
								<td>拜访地址：</td>
								<td>
								<INPUT class=textbox id=sChannel2 style="WIDTH: 180px" maxLength=50 name="visit_addr" value="<s:property value="#saleVisit.visit_addr" />">
								</td>
							</TR>
							...
							<TR>
								...
								<td>拜访详情 ：</td>
								<td>
								<INPUT class=textbox id="cust_phone" style="WIDTH: 180px" maxLength=50 name="visit_detail" value="<s:property value="#saleVisit.visit_detail" />">
								</td>
								<td>下次拜访时间：</td>
								<td>
