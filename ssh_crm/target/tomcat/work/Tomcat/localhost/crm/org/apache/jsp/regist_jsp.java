 ...
 * Generated at: 2018-10-16 14:22:57 UTC
...
public final class regist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t</TR>\r\n");
      out.write("\t\t\t\t\t\t<TR>\r\n");
      out.write("\t\t\t\t\t\t\t<TD background=\"images/regist_title.png\" height=300>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<INPUT id=txtName style=\"WIDTH: 130px\" name=\"user_code\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</TD>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<INPUT id=txtPwd style=\"WIDTH: 130px\" type=password name=\"user_password\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</TD>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</TR>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<TR>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<TD style=\"HEIGHT: 28px\">昵称：</TD>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<TD style=\"HEIGHT: 28px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<INPUT id=txtcode style=\"WIDTH: 130px\" name=\"user_name\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</TD>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype=image src=\"images/regist_button.png\" name=btn>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</TD>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</TR>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</TBODY>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</TABLE>\r\n");
  ...
  private boolean _jspx_meth_s_005fproperty_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /regist.jsp(94,34) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
