 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceImplService", targetNamespace = "http://impl.service.crm4bos2cxf.flyroc.top/", wsdlLocation = "http://127.0.0.1/crm4bos2cxf/service/customer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.crm4bos2cxf.flyroc.top/", "CustomerServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1/crm4bos2cxf/service/customer?wsdl");
    ...
    public ICustomerService getCustomerServiceImplPort() {
        return super.getPort(new QName("http://impl.service.crm4bos2cxf.flyroc.top/", "CustomerServiceImplPort"), ICustomerService.class);
    }
    ...
    public ICustomerService getCustomerServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.crm4bos2cxf.flyroc.top/", "CustomerServiceImplPort"), ICustomerService.class, features);
    }
